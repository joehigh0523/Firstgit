...
class Ace_python_GUI:
    ...
    def __init__(self):
        ...
        self.List5G = []
        self.List2G = []
        for chlval in range(1, 202, 1):
            self.List5G.append(chlval)
            if chlval < 13:
                self.List2G.append(chlval)
        ...
        def selch(*args):
            ...
            if sel == freqband[0]:
                ...
                listch = self.List5G
            self.cmbx5.config(value=listch)
        ...
        chlsel = StringVar()
        chlsel.set('sel band')
        self.cmbx4 = ttk.Combobox(Testerframe4, textvariable=chlsel, value=freqband, width=10)
        self.cmbx4.bind("<<ComboboxSelected>>", selch)
        self.cmbx4.grid(column=0, row=0)
        self.cmbx5 = ttk.Combobox(Testerframe4, value=listch, width=10)
