...
// ****************************************************************
    ...
    #define IQ_API_EXT_C extern "C" __declspec(dllexport)
#elif defined(IQAPI_STATIC)
	#define IQ_API
#elif defined(WIN32)
	#define IQ_API __declspec(dllimport)
    #define IQ_API_EXT_C extern "C" __declspec(dllimport)
#else
    #define IQ_API __attribute__((visibility("default")))
#endif

// Definition for SCPI tester only
#define MAX_SIGNAL_NUMBER       8

// Definitions
#define N_MAX_TESTERS			8 //arun:
#define MAX_LEN_ERR_TXT			4096
...
enum IQVNXN_ERR_CODES
{
	...
	IQAPI_HW_CONTROL_ERROR,				 // Generic error message, check lastErr for details
    IQAPI_INPUT_ERR,
    IQAPI_NOT_IMPLEMENTED_ERR,
    IQAPI_ANALYSIS_ERR,
	...
	IQAPI_INSTRUMENT_DRIVER_OFFSET = 3000
...
enum IQV_CONNECTION_TYPE
{
    ...
    //IQV_CONNECTION_OTHER,        // Other legacy tester, like IQFlex, IQView, IQMax, IQnxn
    IQV_CONNECTION_XSTREAM,
    IQV_CONNECTION_DAYTONA,
    IQV_CONNECTION_DAYTONA_BY_ROUT2,
    IQV_CONNECTION_DAYTONA_160MHZ,
    IQV_CONNECTION_IQFASTTRACK       // Not implemented. Should not be used. exist for temporary backward compatible
};
...
///**********************************************************************************************
/// WIFI OFDM analysis enum
///**********************************************************************************************
enum IQV_OFDM_PACKET_TYPE
{
    IQV_OFDM_PACKET_INVALID = -1,
    IQV_OFDM_PACKET_11B = 0,
    IQV_OFDM_PACKET_11AG,
    IQV_OFDM_PACKET_11N,
    IQV_OFDM_PACKET_11AC
};
...
enum IQV_CHAN_ESTIMATION
{
    IQV_CHAN_ESTIMATION_LTF,
    IQV_CHAN_ESTIMATION_DATA
};

enum IQV_PACKET_FORMAT
{
    IQV_PACKET_FORMAT_AUTO,
    IQV_PACKET_FORMAT_MIX,
    IQV_PACKET_FORMAT_GRE,
    IQV_PACKET_FORMAT_NONHT,
    IQV_PACKET_FORMAT_VHT
};
...
{
    IQV_MIMO_FREQ_SYNC_AUTO    = 0, //!< Performs frequency synchronization using AUTO(FULL for 11ax and LONG for others).
...
enum IQV_SOURCE_ENUM 
{
    ...
    // XStream
    IQV_SOURCE_MODULATION_STATE_OFF    = IQV_SOURCE_WAVE,
    IQV_SOURCE_MODULATION_STATE_ON     = IQV_SOURCE_SIGNAL_GENERATOR
};
...
{
    IQV_FREQ_SYNC_AUTO = 0,                   //!< Indicates frequency synchronization is applying tester default. */
...
enum IQV_11B_METHOD_ENUM
{
    ...
    IQV_11B_STANDARD_2007_TX_ACC    = 3,     //!< EVM Method Standard 2007
    IQV_11B_STANDARD_2016_TX_ACC    = 4     //!< EVM Method Standard 2016
};
...
enum IQV_RF_ENABLE_ENUM
{
    ...
    // XStream
    IQV_POWER_STATE_OFF = IQV_RF_DISABLED,
    IQV_POWER_STATE_ON  = IQV_RF_ENABLED
};
...
enum IQV_PORT_ENUM
{
	...
	IQV_PORT_1	   = IQV_PORT_LEFT,				/*!< RF uses RF1A/RF1B.			*/
    IQV_PORT_2	   = IQV_PORT_RIGHT,			/*!< RF uses RF2A/RF2B.			*/
	IQV_PORT_3	   = 4,						/*!< RF uses RF3A/RF3B.			*/
	IQV_PORT_4	   = 5,						/*!< RF uses RF4A/RF4B.			*/
    IQV_PORT_BB    = 33,					/*!< BB ports in use.			*/

    // XStream definition
    //IQV_PORT_ENUM_RF1A = 2,
    //IQV_PORT_ENUM_RF2A = 3
};
...
enum IQV_ALC_MODES
{
    ...
    // For XStream
    IQV_ALC_STATE_SINGLE    = IQV_ALC_MANUAL,
    IQV_ALC_STATE_AUTO      = IQV_ALC_AUTO_ON_TIMEOUT,
    IQV_ALC_STATE_OFF       = IQV_ALC_OFF
...
enum IQV_CAPTURE_DATA_HANDLING_ENUM
{
    ...
    IQV_DATA_IN_SCPI_BASED_TESTER = IQV_DATA_IN_MATLAB            //!< Indicates data is stored in SCPI based tester
};
...
enum IQV_CAPTURE_TYPE_ENUM
{
    ...
    IQV_VHT_160_WIDE_BAND_CAPTURE_TYPE,
	IQV_VHT_20_40_IN_80_WIDE_BAND_CAPTURE_TYPE,    // !< Indicate as 20in80 or 40in80 wind-band capture
	IQV_VHT_80P80_WIDE_BAND_CAPTURE_TYPE,
	IQGIGIF_WIDE_CAPTURE_TYPE,
	IQGIG_WIDE_CAPTURE_TYPE,
    IQV_SIDE_BAND_IN_160_WIDE_BAND_CAPTURE_TYPE,

	IQXSM_HT_20_BAND_60M_CAPTURE_TYPE = 1000,
	IQXSM_HT_40_BAND_50M_CAPTURE_TYPE,
	IQXSM_HT_40_BAND_120M_CAPTURE_TYPE,
	IQXSM_VHT_80_BAND_80M_CAPTURE_TYPE,
	IQXSM_VHT_80_BAND_240M_CAPTURE_TYPE,
};
...
/// ******************************************************************************
/// For SCPI based tester
/// ******************************************************************************
enum IQV_LOCK_SESSION
{
    IQV_LOCK_SESSION_REQUEST,
    IQV_LOCK_SESSION_FORCE_RELEASE,
    IQV_LOCK_SESSION_RELEASE
};

enum IQV_NUM_SYMBOLS_MODE {    /* NSYMbols_Mode in CONFigure:OFDM:NSYMbols, CONFigure:OFDM:NSYMbols? */
    IQV_NUM_SYMBOLS_MODE_LSIG,                 /* LSIG,       L-SIG Field */
    IQV_NUM_SYMBOLS_MODE_POW                  /* POW,        Signal Power */ 
};

enum IQV_SAVE_SCPI_FILE_TYPE_ENUM
{
    IQV_SAVE_IQVSA_FILE,	    //!< Indicates that file type should be .iqvsa type. User will determine the file name with extension.
    IQV_SAVE_NORMALIZE_FILE	    //!< Indicates that file is normalized, file type should be .iqvsg type. User will determine the file name with extension.
};

enum IQV_CONFIGURE_STANDARD
{
    IQV_CONFIGURE_STANDARD_DSSS,        // WiFi 802.11b
    IQV_CONFIGURE_STANDARD_OFDM         // WiFi 802.11a/g/n/ac  this is the default
};

enum IQV_ANALYZED_FREQUENCY_SEGMENT_TYPE
{
    IQV_ANALYZED_FREQUENCY_SEGMENT_1,
    IQV_ANALYZED_FREQUENCY_SEGMENT_2,
    IQV_ANALYZED_FREQUENCY_SEGMENT_ALL
};
